...
class Dropzone {
    ...
    init(name: string, zone: { x1: number, y1: number, x2: number, y2: number, x3?: number, y3?: number },
    ...
    createNew(name: string, zone: { x1: number, y1: number, x2: number, y2: number, x3?: number, y3?: number },
