...
class GoodNightBear extends Base {
    static vidKey: string = 'goodnight_bear';
    biome: string = null;
    ...
    constructor(key: string, biome: string) {
        super(key);
        this.biome = biome;
    }
    ...
    preload() {
        ...
        this.load.video(GoodNightBear.vidKey, [GoodNightBear.vidKey + '.mp4'], 'canplay');
    ...
    create() {
        ...
        this.video = new Phaser.GameObjects.Video(this, this.game.canvas.width / 2, 0, GoodNightBear.vidKey);
        ...
        this.video.on('pointerdown', function (this: GoodNightBear) {
        ...
        this.bottomBar = new UIBar(this, 0, this.game.canvas.height, CONST.UI.BAR_TEXTURE, this.HUD, [
            {
                ...
                outAnim: 'exit_out',
                overAnim: 'exit_over',
                callback: function (this: GoodNightBear) {
            ...
            },
            {
                ...
                origin: { x: 0.5, y: 0.5 },
                callback: function (this: GoodNightBear) {
                    let key = Utils.concatStrings(['k1_demo', this.biome, 'a1'], '_');
                    this.changeAct(key);
                }.bind(this),
                callbackContext: this,
            ...
            },
            {
                ...
                origin: { x: 0.5, y: 0.5 },
                callback: function (this: GoodNightBear) {
                    let key = Utils.concatStrings(['k1_demo', this.biome, 'a2'], '_');
                    this.changeAct(key);
                }.bind(this),
                callbackContext: this,
                outAnim: 'bear_paw_default',
            ...
            },
            {
                ...
                origin: { x: 0.5, y: 0.5 },
                callback: function (this: GoodNightBear) {
                    let key = Utils.concatStrings(['k1_demo', this.biome, 'a3'], '_');
                    this.changeAct(key);
                }.bind(this),
                callbackContext: this,
                outAnim: 'bear_paw_default',
            ...
            },
            {
                ...
                origin: { x: 0.5, y: 0.5 },
                callback: function (this: GoodNightBear) {
                    let key = Utils.concatStrings(['k1_demo', this.biome, 'a4'], '_');
                    this.changeAct(key);
                }.bind(this),
                callbackContext: this,
                outAnim: 'bear_paw_default',
            ...
            },
            {
                ...
                origin: { x: 0.5, y: 0.5 },
                callback: function (this: GoodNightBear) {
                    let key = Utils.concatStrings(['k1_demo', this.biome, 'a5'], '_');
                    this.changeAct(key);
                }.bind(this),
                callbackContext: this,
                outAnim: 'bear_paw_default',
            ...
            },
            {
                ...
                origin: { x: 0.5, y: 0.5 },
                callback: function (this: GoodNightBear) {
                    let key: string = Utils.concatStrings(['k1_demo', this.biome, 'a6'], '_');
                    this.changeAct(key);
                }.bind(this),
                callbackContext: this,
                outAnim: 'bear_paw_default',
...
export class Polar extends GoodNightBear {
    constructor(key: string) {
        super(key, 'polar');
    }
}

export class Brown extends GoodNightBear {
    constructor(key: string) {
        super(key, 'brown');
    }
}

export class Panda extends GoodNightBear {
    constructor(key: string) {
        super(key, 'panda');
    }
}